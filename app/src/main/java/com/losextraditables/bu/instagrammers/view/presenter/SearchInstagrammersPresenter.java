...
public class SearchInstagrammersPresenter extends BuPresenter<SearchInstagrammersPresenter.View> {
  ...
  @Inject public SearchInstagrammersPresenter(UseCaseHandler useCaseHandler,
      SearchInstagrammersUseCase searchInstagrammersUseCase,
      SearchedInstagrammerModelMapper searchedInstagrammerModelMapper) {
  ...
  public void search(String query, String accessToken) {
    ...
    createUseCaseCall(searchInstagrammersUseCase).args(query, accessToken)
